...
# FUNZIONE SPECIFICA PER INVIO CODICE OTP VIA EMAIL
            ...
            if uid == "Admin":
                ...
                with st.spinner("Invio del codice OTP in corso..."):
                    if send_otp(uid, otp_code):
                        ...
                        st.error("Errore nell'invio dell'email. Riprova più tardi.")
            else:
...
# STEP 2: VERIFICA
    ...
    with col_mid:
        ...
        if st.button("CONFERMA"):
            # Controllo incrociato: Password fissa per Admin, codice dinamico per gli utenti
